...
const deptsData = [
  ...
  },
  {
    ...
    shortDesc:
      "قسم تكنولوجيا المحاسبة يجمع بين المعرفة المحاسبية والتقنيات الرقمية الحديثة، ويهدف إلى إعداد كوادر قادرة على استخدم ...",
    fullDesc:
      "قسم تكنولوجيا المحاسبة يجمع بين المعرفة المحاسبية والتقنيات الرقمية الحديثة، ويهدف إلى إعداد كوادر قادرة على استخدام البرمجيات المحاسبية المتقدمة والأنظمة السحابية في إعداد التقارير المالية والتدقيق الإلكتروني والتحصيل الضريبي، بما يتناسب مع احتياجات التحول الرقمي في قطاع المال والأعمال.",
    icon: "📈",
  ...
  },
  {
    ...
    shortDesc:
      "قسم نظم المعلومات الإدارية في تكنولوجيا الإدارة والأعمال يركز على دمج تقنيات الحوسبة مع مفاهيم الإدارة لتحسين الأد ...",
    fullDesc:
      "قسم تكنولوجيا الإدارة والأعمال يركز على دمج تقنيات الحوسبة مع مفاهيم الإدارة التقليدية لتحسين الأداء التنظيمي، وتصميم الهياكل الرقمية للمؤسسات. يدرس الطلاب إدارة الموارد البشرية والمالية إلكترونياً، ونظم إدارة الجودة الشاملة، والتخطيط الاستراتيجي الرقمي لتحقيق التميز والريادة التنافسية.",
    icon: "🏢",
...
export default function About() {
  ...
  return (
    <div className="about-page-view" style={{ background: "var(--bg)" }}>
      ...
      <section
        className="hero"
        style={{ padding: "80px 0 50px", minHeight: "auto" }}
      >
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <h1
            ...
            style={{ fontSize: "clamp(28px, 5vw, 48px)", marginBottom: "20px" }}
          >
          ...
          >
            المنصة الإلكترونية الأولى لتسهيل الحياة الأكاديمية والإرشاد الطلابي
            داخل الكلية، بهدف إيجاد قنوات تواصل فعالة ومؤتمتة بين الطالب، المرشد
            الأكاديمي، وإدارة الكلية.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="about-hero-image-card">
            ...
            <div className="about-hero-overlay">
              ...
              <p>
                نلتزم بتقديم بيئة تعليمية رائدة تدعم الابتكار والريادة للطلاب.
              </p>
            </div>
          </div>
        </div>
            ...
            {deptsData.map((dept) => (
              <div key={dept.id} className="dept-card">
                <div>
                  ...
                  <p className="dept-card__desc">• {dept.shortDesc}</p>
                </div>
                <button
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="feature-card__desc">
                أن نكون النموذج الرائد في تقديم الخدمات الطلابية والإرشاد
                الأكاديمي الرقمي على مستوى الجامعات المصرية.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-card__desc">
                توجيه الطالب خطوة بخطوة في اختيار التخصص والمقررات بما يتناسب مع
                قدراته واهتماماته وخطة تخرجه.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-card__desc">
                تعزيز التواصل البناء والمستمر بين الطلاب وأعضاء هيئة التدريس
                لتبادل الخبرات وحل المشكلات الأكاديمية.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="dept-modal__body">
              ...
              <div className="dept-modal__badge-grid">
                {selectedDept.badges.map((b, index) => (
                  <div key={index} className="dept-modal__badge">
                    {b}
                  </div>
                ))}
              </div>
